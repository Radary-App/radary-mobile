...
part of 'add_emergency_state.dart';
...
abstract class Loading<T> implements AddEmergencyState<T> {
...
abstract class Success<T> implements AddEmergencyState<T> {
...
abstract class Error<T> implements AddEmergencyState<T> {
