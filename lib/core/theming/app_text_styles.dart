...
class AppTextStyles {
  ...
  static TextStyle font14DarckBlueMedium = TextStyle(
      color: darkBlue,
      fontSize: 14.sp,
      fontWeight: FontWeightHelper.medium // Semi-bold weight
      );
  ...
  static TextStyle font18Redmedium = const TextStyle(
      color: red, fontSize: 18, fontWeight: FontWeightHelper.medium);
  static TextStyle font14Bluemedium = const TextStyle(
      color: blue209, fontSize: 14, fontWeight: FontWeightHelper.medium);

  static TextStyle font16Gray880Semibold = const TextStyle(
      color: gray880, fontSize: 16, fontWeight: FontWeightHelper.semiBold);
